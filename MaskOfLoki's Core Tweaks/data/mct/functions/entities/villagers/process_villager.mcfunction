...
execute if entity @s[nbt={Profession:3,Career:2}] run function #mct:process_weapon_smith
execute if entity @s[nbt={Profession:3,Career:3}] run function #mct:process_tool_smith
