...
execute as @e[scores={croutching=1,twerk_ready=0},nbt={OnGround:1}] run scoreboard players set @s twerk_ready 1
...
execute as @a[scores={croutching=0,twerk_ready=1},nbt={OnGround:1}] at @s run function gs:on_twerk
