...
execute if score disable.grow_sapling gs.config matches 0 if block ~ ~ ~ minecraft:acacia_sapling if score @s gs.temp matches 0 run particle minecraft:happy_villager ~ ~0.5 ~ 0.5 0.5 0.5 50 10 normal
...
execute if score disable.grow_sapling gs.config matches 0 if block ~ ~ ~ minecraft:birch_sapling if score @s gs.temp matches 0 run particle minecraft:happy_villager ~ ~0.5 ~ 0.5 0.5 0.5 50 10 normal
...
execute if score disable.grow_sapling gs.config matches 0 if block ~ ~ ~ minecraft:dark_oak_sapling if score @s gs.temp matches 0 run particle minecraft:happy_villager ~ ~0.5 ~ 0.5 0.5 0.5 50 10 normal
...
execute if score disable.grow_sapling gs.config matches 0 if block ~ ~ ~ minecraft:jungle_sapling if score @s gs.temp matches 0 run particle minecraft:happy_villager ~ ~0.5 ~ 0.5 0.5 0.5 50 10 normal
...
execute if score disable.grow_sapling gs.config matches 0 if block ~ ~ ~ minecraft:spruce_sapling if score @s gs.temp matches 0 run particle minecraft:happy_villager ~ ~0.5 ~ 0.5 0.5 0.5 50 10 normal
...
execute if score disable.grow_sapling gs.config matches 0 if block ~ ~ ~ minecraft:oak_sapling if score @s gs.temp matches 0 run particle minecraft:happy_villager ~ ~0.5 ~ 0.5 0.5 0.5 50 10 normal
