execute if score @s crafter_crafted matches ..0 positioned ~ ~1.5 ~ if entity @e[type=item,distance=..0.5,nbt={Item:{id:"minecraft:barrier",tag:{item_id:0}}}] run scoreboard players set @s crafter_crafted 1
