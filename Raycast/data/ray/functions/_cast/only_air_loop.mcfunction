...
execute as @s at @s if block ~ ~ ~ #ray:air unless score @s ray.distance >= "max_raycast" ray.globals run tp @s ^ ^ ^0.05
...
execute as @s at @s if block ~ ~ ~ #ray:air unless score @s ray.distance >= "max_raycast" ray.globals run function ray:_cast/only_air_loop