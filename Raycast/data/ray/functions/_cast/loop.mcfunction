...
execute as @s at @s if block ~ ~ ~ #ray:nonsolid unless score @s ray.distance >= "max_raycast" ray.globals run tp @s ^ ^ ^0.5
...
execute as @s at @s if block ~ ~ ~ #ray:nonsolid unless score @s ray.distance >= "max_raycast" ray.globals run function ray:_cast/loop